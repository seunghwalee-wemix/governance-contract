...
const setStakingReward = require("./scripts/setRegistry_task").setRegistry;
...
task("setStakingReward", "set Staking reward address")
.addParam("conf").setAction(async (taskArgs, hre)=>{
    await setStakingReward(hre, taskArgs.conf);
})
